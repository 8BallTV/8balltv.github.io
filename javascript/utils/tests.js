 ...
 * @return {null}
 */
export function generateErrorMessageForParserTests(
  expectedFileName,
  expectedtimeToStartPlayingVideo,
  actualFilename,
  actualPlaybackTime
) {
  ...
  console.log(
    `    %cExpected playback start time was: ${expectedtimeToStartPlayingVideo}`,
    colorString
  );
  console.log(
    `    %cActual playback start time name was: ${actualPlaybackTime}`,
    colorString
  );
}
